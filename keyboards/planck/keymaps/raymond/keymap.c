...
{KC_LGUI,  MO(FKEY), MO(NUMS), LOWERKEY, MY_CTL_ESC, KC_BSPC, KC_ENT,  KC_SPC, RAISEKEY, MO(CURS), KC_LALT, KC_TAB}
},
...
{XXXXXXX, I3_L,    S(KC_INS), I3_R,    XXXXXXX, XXXXXXX, KC_AMPR, MY_DAMP, KC_TILD, KC_AT,   KC_EXLM, KC_QUES},
...
{KC_Z,    KC_CIRC, KC_PERC, KC_UNDS, XXXXXXX, XXXXXXX, KC_AMPR, MY_DAMP, KC_TILD, KC_AT,   KC_EXLM, KC_QUES},
...
{XXXXXXX, XXXXXXX, S(KC_DEL), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           WINCUNI,         OSXUNI,  LNXUNI,  WINUNI},
